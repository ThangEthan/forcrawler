#!/bin/zsh
# This script get Postcode from WOZ site to fill up the missing postcode in kamernet data, It doesn't guaranty 100% of accuracy as we only know street and city name.
RED='\033[0;31m'
NC='\033[0m'

function req(){
    # Similar to get_cor.sh
